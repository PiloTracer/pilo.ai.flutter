...
Fixture: must FAIL both verifiers. Defects are marked inline.
...
- FR4 Export notes as PDF — DEFECT: no task covers this
...
- F9-T1 Orphan task — DEFECT: traces to nothing, milestone F9 undeclared
