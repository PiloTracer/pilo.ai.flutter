...
**Pairs with:** `flutter-stack` (next step), `flutter-foundation` (needs the scaffold), `flutter-deploy` (installs the framework itself into a repo — this skill sets up the *project* side).
